...
public class MainActivity extends AppCompatActivity {
    ...
    public void showDialog(DialogType dialogType, Trainee currentTrainee) {
        ...
        TextView tvHeading = dialog.findViewById(R.id.textView);
    ...
    public void loadTrainees() {
        traineeService.getAllTrainees()
                .enqueue(new Callback<List<Trainee>>() {
                    @Override
                    public void onResponse(retrofit2.Call<List<Trainee>> call, retrofit2.Response<List<Trainee>> response) {
                    ...
                    @Override
                    public void onFailure(retrofit2.Call<List<Trainee>> call, Throwable t) {
        ...
        builder.setPositiveButton("Yes", (dialog, which) -> {
            traineeService.deleteTrainee(traineeToDelete.getId())
                    .enqueue(new Callback<Trainee>() {
                        @Override
                        public void onResponse(retrofit2.Call<Trainee> call, retrofit2.Response<Trainee> response) {
                        ...
                        @Override
                        public void onFailure(retrofit2.Call<Trainee> call, Throwable t) {
                            Toast.makeText(MainActivity.this, "An error has occurred!", Toast.LENGTH_SHORT).show();
                        }
                    });
        });
